...
- **[TWZRD Agent Intel](https://intel.twzrd.xyz)**: Agent wallet identity verification for RAG pipelines. Trust-score the calling agent before granting access to paid document retrieval or premium embedding APIs. Free MCP: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`
